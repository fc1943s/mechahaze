                    ...
                    if (element instanceof PortModel && !this.sourcePort) {
                        ...
                        */
                        ...
                        if (this.sourcePort.canLinkToPort(element)) {
                            ...
                            // console.log(element, this.sourcePort);
                            
                            let arr1 = [element, this.sourcePort];
                            let arr2 = arr1.sort((a, b) => a.getOptions().in ? 1 : -1);
                            let arr3 = arr2.map(x => x.getParent().getOptions().name + "|" + x.getOptions().name.split('\u00A0')[0]);
