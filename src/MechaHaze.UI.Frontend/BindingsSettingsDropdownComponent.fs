...
module BindingsSettingsDropdownComponent =
    ...
    let confirmationModal (props: ModalManager.PrivateManager) =
        ...
        Modal.modal [ Modal.IsActive props.Visible ][
              
            Modal.background [ Props [ OnClick onToggle ] ][]
            ...
            Modal.Card.card [][
                Modal.Card.head [][
                    ...
                    Delete.delete [ Delete.OnClick onToggle ][]
                ]
                ...
                Modal.Card.foot [][
                    ...
                    Button.button [ Button.OnClick onToggle ][
                        str "Cancel"
                    ]
                ]
            ]
    ...
    let ``default`` = FunctionComponent.Of (fun props ->
        ...
        let events = {|
            OnPresetDeleteClick = fun presetName _ ->
                modalManager.Confirm (fun _ ->
                    props.TogglePreset presetName
                )
                
            OnPresetClick = fun presetName _ ->
                props.SetActiveBindingsPreset presetName
                
            OnPresetAdd = fun presetName ->
        ...
        div [][
            ...
            Tabs.tabs [ Tabs.Size IsSmall
                ...
                Tabs.tab [ tabManager.IsActive PresetList ][
                    a [ tabManager.CreateOnClick PresetList ][ str "Presets" ]
                ]
                
                Tabs.tab [ tabManager.IsActive PresetAdd ][
                    a [ tabManager.CreateOnClick PresetAdd ][ str "+" ]
                ]
            ]
            
            div [ Style [ tabManager.CreateDisplay PresetList ] ][
                ...
                |> Seq.map (fun presetName ->
                    ...
                    Control.div [ Control.Props [ Key presetName
                        ...
                        Tag.list [ Tag.List.HasAddons ][
                            ...
                            Tag.tag [][
                                if active
                                then span [ Style [ Color "#fff" ] ][ str presetName ]
                                else a [ OnClick (events.OnPresetClick presetName) ][ str presetName ]
                            ]
                            
                            if not active then
                                Tag.delete [ Tag.Props [ OnClick (events.OnPresetDeleteClick presetName) ] ][]
                        ]
                    ]
                )
                |> Seq.toList
            ...
            div [ Style [ tabManager.CreateDisplay PresetAdd ] ][
